...
class RailwaySystem:
    ...
    def book_ticket(self):
        ...
        print("\n--- Book Ticket ---")
        name = input("Enter Passenger Name: ") [cite: 4]
        try:
            age = int(input("Enter Passenger Age: ")) [cite: 4]
        except ValueError:
            print("Invalid age. Please enter a number.")
            return

        # Assign first available seat and generate a random 4-digit ID
        seat_no = self.available_seats.pop(0) [cite: 4, 5]
        booking_id = random.randint(1000, 9999) [cite: 4]
        ...
        print(f"Success! Ticket booked for {name}. Seat No: {seat_no}. Booking ID: {booking_id}")
